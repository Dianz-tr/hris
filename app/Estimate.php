...
class Estimate extends Model
{
    ...
    protected $fillable = [
        'estimate_id', 'client_id', 'project_id', 'email', 'tax_id', 'client_address', 'billing_address', 'estimate_date', 'expiry_date', 'total', 'tax', 'discount', 'grand_total', 'other_info', 'status'
    ];
